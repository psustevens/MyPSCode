function Get-vCenterFolderByPath{
<# .SYNOPSIS Retrieve folders by giving a path 
    .DESCRIPTION The function will retrieve a folder by it's path. The path can contain any type of leaf (folder or datacenter). 
    ...
    .EXAMPLE 
    PS> Get-vCenterFolderByPath -Path "Folder1/Datacenter/Folder2"
    .EXAMPLE
    PS> Get-vCenterFolderByPath -Path "Folder1>Folder2" -Separator '>'
#>
    param(
    [CmdletBinding()]
...
Get-vCenterFolderByPath "Finance"
